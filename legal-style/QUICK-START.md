# Oregon Legal Style: Quick Start

> **Purpose**: The 80% of daily lookups — fast answers with examples
> **Last updated**: 2026-02-20
>
> When you need the full rule, follow the links to the topic files.
...
ORS 174.010 and 174.020           ← two sections
ORS chapter 174                   ← entire chapter
```
...
→ Full rules: [`lc-form-style-manual/ors-citations.md`](lc-form-style-manual/ors-citations.md)
...
**Never use "supra"** — Oregon courts do not use supra as a substitute for short citations.

**No periods in abbreviations**: `Or App`, `P3d`, `S Ct` — not `Or. App.`, `P.3d`

→ Full rules: [`appellate-style-manual/citations.md`](appellate-style-manual/citations.md) §§ II.A–II.B
...
→ Legislative: [`lc-form-style-manual/ors-citations.md`](lc-form-style-manual/ors-citations.md) § 3
...
Three-part hyphenated number: `{agency code}-{division}-{rule number}`

→ Appellate: [`appellate-style-manual/citations.md`](appellate-style-manual/citations.md) § III.A.9
→ Legislative: [`lc-form-style-manual/ors-citations.md`](lc-form-style-manual/ors-citations.md) § 7
...
→ [`lc-form-style-manual/ors-citations.md`](lc-form-style-manual/ors-citations.md) § 6
...
After codification, LC updates internal references to ORS citations.

→ [`lc-form-style-manual/ors-citations.md`](lc-form-style-manual/ors-citations.md) § 5

---

## 7. Shall / May / Must / May Not
...
→ [`lc-form-style-manual/grammar-punctuation.md`](lc-form-style-manual/grammar-punctuation.md) § 2
...
→ Full rules: [`lc-drafting-manual/defined-terms.md`](lc-drafting-manual/defined-terms.md)
→ [`lc-form-style-manual/grammar-punctuation.md`](lc-form-style-manual/grammar-punctuation.md) § 6

---

## 9. Bill Structure: Standard Section Order

A standard bill follows this sequence:

1. Heading (measure number, LC number)
2. Title (`AN ACT Relating to...`)
3. Enacting clause (`Be It Enacted by the People of the State of Oregon:`)
4. Definitions section (if needed)
5. Act name section (if needed)
6. Policy/purpose statement (if needed)
7. Substantive operative sections
8. Conforming/coordinating amendments
9. Repealing sections
10. Savings clause (if needed)
11. Severability clause (if needed)
12. Effective date section (if not default)
13. Emergency clause (if needed; mutually exclusive with referendum clause)

→ Full rules: [`lc-drafting-manual/bill-structure.md`](lc-drafting-manual/bill-structure.md)
...
→ [`lc-form-style-manual/bill-formatting.md`](lc-form-style-manual/bill-formatting.md) § 3
→ [`lc-drafting-manual/numbering-formatting.md`](lc-drafting-manual/numbering-formatting.md)

---

## 11. Quotations (Court Opinions)

**50+ words** → block quotation (required). Single spaced, double indented.

**Ellipsis** → three asterisks: `* * *` (not periods)
...
→ Full rules: [`appellate-style-manual/quotations.md`](appellate-style-manual/quotations.md)
...
| Numbers | Spell out 1–10; numerals for 11+ | Numerals generally |
| Hyphenation | Hyphenate compound modifiers before noun | Same general rule |
...
| Oregon Constitution citation | [`appellate-style-manual/citations.md`](appellate-style-manual/citations.md) § III.A.2 |
| Federal citations | [`appellate-style-manual/citations.md`](appellate-style-manual/citations.md) § III.B |
| Quotation rules (ellipsis, brackets) | [`appellate-style-manual/quotations.md`](appellate-style-manual/quotations.md) |
| Opinion formatting (title page, headings) | [`appellate-style-manual/formatting.md`](appellate-style-manual/formatting.md) |
| Italics/uppercase in opinions | [`appellate-style-manual/style-grammar.md`](appellate-style-manual/style-grammar.md) |
| Word pairs (absent, prior, that/which) | [`appellate-style-manual/style-grammar.md`](appellate-style-manual/style-grammar.md) § III |
| Shall/may/must/may not | [`lc-drafting-manual/sentence-construction.md`](lc-drafting-manual/sentence-construction.md) § 4 |
| Defined terms | [`lc-drafting-manual/defined-terms.md`](lc-drafting-manual/defined-terms.md) |
| Bill section numbering | [`lc-drafting-manual/numbering-formatting.md`](lc-drafting-manual/numbering-formatting.md) |
| Bill structure and order | [`lc-drafting-manual/bill-structure.md`](lc-drafting-manual/bill-structure.md) |
| Amending/repealing ORS sections | [`lc-form-style-manual/bill-formatting.md`](lc-form-style-manual/bill-formatting.md) |
| Grammar/punctuation in statutes | [`lc-form-style-manual/grammar-punctuation.md`](lc-form-style-manual/grammar-punctuation.md) |
| Where rules differ across sources | [`cross-reference.md`](cross-reference.md) |
