# LC Form and Style Manual for Legislative Measures — Reference Index

## Source

**Title**: LC Form and Style Manual for Legislative Measures
**Edition**: 2025-2026
**Publisher**: Oregon Legislative Counsel (LC)
**Drafter contact**: 503-986-1243
**Scope**: Oregon Revised Statutes (ORS), Oregon Constitution, Oregon Laws (session laws),
Oregon Administrative Rules (OAR), Oregon Rules of Civil Procedure (ORCP), and federal
statutes; formatting and style rules for all types of Oregon legislative measures.

## About This Manual

The LC Form and Style Manual establishes the official uniform system for preparation of
Oregon legislative measures. It is prepared and maintained by the Office of the Legislative
Counsel. The manual incorporates chamber rules from both the Oregon House of
Representatives and the Oregon Senate.

**Shaded text in the original manual** is explanatory guidance written for LC drafting staff
explaining internal office procedures, system commands, and software-specific instructions.
That internal guidance is not reproduced in these reference files; only the substantive drafting
rules and examples applicable to the form and content of Oregon legislative measures are
included.

## What These Files Cover

This directory contains four structured markdown reference files extracted from the full
manual. Each file is designed for LLM use: rules and examples are always co-located, actual
statutory and bill text is quoted verbatim, and nothing is summarized or omitted.
...
- **D**: Ratifying amendments to United States Constitution
- **E**: Budget and appropriation bills
- **F**: Conflicts (concurrent amendments to the same ORS section)
- **G**: Series and adding sections to a series
- **H**: Interstate compacts and uniform acts
- **I**: ORS numbering and chapter organization
- **J**: ORCP amendments
...
## Key Conventions Used in the Manual

- **Boldfaced type** in a bill denotes new material being added to existing law.
- **[Brackets and italic type]** in a bill denote material being deleted from existing law.
