...
> Add new entries at the bottom; do not renumber existing entries.
>
> **CMS edition**: 17th edition (2017). Tag any update from a later edition as
> `[CMS 18th ed. change]`.
...
| # | Topic | What EoS Says | What CMS Says | PCP Override | Resolution |
| --- | --- | --- | --- | --- | --- |
| 1 | **Serial (Oxford) comma** | Not consistently required; practice is inconsistent across editions | §6.19: required in a series of three or more items in running text | (none) | **CMS governs.** Always use the serial comma. |
| 2 | **Active voice** | Strongly preferred as a default rule (Rule 14 / Principle 11): "use the active voice" | §5.117: active is generally preferred but passive is valid when the actor is unknown, unimportant, or should be de-emphasized | (none) | **CMS governs.** Use passive when it serves the sentence: "The motion was denied." |
| 3 | **Sentence fragments** | Prohibited: "Do not break sentences in two" (Rule 5 equivalent) | §5.238: acceptable for rhetorical effect — transition sentences, short responses, emphatic statements | (none) | **CMS governs.** Permitted judiciously in less formal contexts. Avoid in formal legal or academic writing. |
| 4 | **Split infinitives** | Discouraged (White's revisions soften but do not endorse) | §5.168: split infinitives are grammatically correct; splitting is often preferable when the adverb modifies only the infinitive | (none) | **CMS governs.** Split when it produces the clearest sentence. "to clearly state" is fine. |
| 5 | ***None*: singular or plural** | Treat as singular: "None of them **is** guilty" | §5.258: notional agreement — *none* takes plural when the reference is clearly plural ("None of the arguments **were** compelling"); singular for a single-unit reference | (none) | **CMS governs.** Match notional meaning: "None of the briefs **were** filed" (plural concept). |
| 6 | **Paragraph structure** | One idea per paragraph; topic sentence at or near opening | No fixed rule; unity still valued but paragraph structure serves content and argument | (none) | **CMS governs.** Structure paragraphs to serve the argument. Single-topic paragraphs are still good practice. |
| 7 | **Numbers: spell-out threshold** | Spell out numbers one through nine; use numerals for 10 and above | §9.2–9.3: spell out one through one hundred in running text; many exceptions (dates, percentages, measurements, technical quantities) | (none) | **CMS governs.** Spell out one through one hundred; follow CMS ch. 9 exceptions. |
| 8 | ***Due to* as compound preposition** | Restrict to adjectival use: "Due to illness" where *due* modifies a noun | §5.250: "due to" is widely accepted as a compound preposition equivalent to "because of" in formal prose | (none) | **CMS governs.** "Due to the amendment, §174.010 changed" is acceptable. |
| 9 | **Comma after short introductory phrase** | Use a comma after introductory elements | §6.29: a comma may be omitted after a very short (roughly four words or fewer) introductory phrase when there is no risk of misreading | (none) | **CMS governs.** Optional for very short introductory phrases when meaning is clear. Always use for longer introductory elements. |
| 10 | ***Which* in restrictive clauses** | *Which* in a restrictive clause is an error; always use *that* for restrictive | §5.254: *that* is standard for restrictive relative clauses; *which* is standard for nonrestrictive clauses (with comma); however, *which* can occasionally appear in a restrictive clause in formal British usage | (none) | **CMS governs** (U.S. standard): *that* for restrictive (no comma), *which* + comma for nonrestrictive. Maintain this distinction rigorously in American legal and formal writing. |
| 11 | **Possessives: proper names ending in *s*** | Always add *'s*: "Burns's," "James's" | §7.20: same general rule; add *'s* to most singular proper names ending in *s*; exception for classical and biblical names: Jesus', Moses', Achilles', Xerxes' | (none) | **CMS governs.** Add *'s* to most names; classical names take only '. |
...
| 25 | **Italics for foreign and Latin words** | Silent; no guidance | §7.47–7.49: italicize foreign words and phrases not yet anglicized on first use; do not italicize if the term is in Merriam-Webster as a standard English entry | (none) | **CMS governs.** Italicize *e.g.*, *i.e.*, *supra*, *infra*, *inter alia*, *prima facie*, *res judicata* in running text. Do not italicize in legal citation strings where the form is conventional. |
| 26 | **Capitalization of acronyms in titles** | Silent; no guidance | §8.157: in headline-style capitalization, acronyms and initialisms retain their all-caps form regardless of position | (none) | **CMS governs.** Write "The Role of the **IRS** in Tax Administration" — *IRS* stays all-caps even mid-title. Abbreviations like *U.S.* retain their standard form. |

---

## How to Add New Entries

When you encounter a new EoS/CMS/PCP divergence in practice:
