...
Connect individual decisions to broader strategy, risk, standards, or governance implications. If a choice has implications beyond the immediate problem, state them.
...
Do not present assumptions as facts. If the document depends on staffing levels, pricing, or approval decisions remaining constant, say so.
